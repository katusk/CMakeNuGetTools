...
function(_nuget_git_parse_semantic_version
    ...
    string(REGEX MATCH "${REGEX_SEMVER}" MATCH_TAG_WITHOUT_PREFIX "${TAG_WITHOUT_PREFIX}")
    _nuget_helper_error_if_empty("${MATCH_TAG_WITHOUT_PREFIX}" "Cannot match \"${TAG_WITHOUT_PREFIX}\" with \"${REGEX_SEMVER}\": ")
    ...
    set(REGEX_SEMVER_PRERELEASE "^(${REGEX_NUMBER})\.(${REGEX_NUMBER})\.(${REGEX_NUMBER})(-${REGEX_PRERELEASE})")
    string(REGEX MATCH "${REGEX_SEMVER_PRERELEASE}" MATCH_SEMVER_PRERELEASE "${TAG_WITHOUT_PREFIX}")
    if(NOT "${MATCH_SEMVER_PRERELEASE}" STREQUAL "")
